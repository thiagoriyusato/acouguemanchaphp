...
<body>
    ...
    <img src="manchalogo.png" width="30" height="30" class="d-inline-block align-top" alt="">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
        ...
        echo"
        <li class='nav-item active'>
        <a class='nav-link' href='product.php'> Mercadoria <span class='sr-only'>(current)</span></a>
        </li>";
        echo" 
        <li class='nav-item active'>
        <a class='nav-link' href='customer.php'> Clientes <span class='sr-only'>(current)</span></a>
        </li>";
      } 
      ?>
        </div>
